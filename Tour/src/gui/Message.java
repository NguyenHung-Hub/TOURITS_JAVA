...
public class Message extends JFrame {
	...
	public JButton getButtonCancle() {
		return buttonCancle;
	}
	public void setButtonCancle(JButton buttonCancle) {
	...
	private void buidMessage() {
		...
		buttonExit.setBackground(new Color(0, 0, 0, 0));
		buttonExit.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				buttonExit.setBackground(MainScreen.COLOR_MAIN);
			}
		});
		...
		buttonCancle.setCursor(new Cursor(Cursor.HAND_CURSOR));
		wrapper.add(buttonCancle);
		add(wrapper);
